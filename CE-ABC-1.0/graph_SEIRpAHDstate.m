% -----------------------------------------------------------------
%  graph_SEIRpAHDstate.m
% ----------------------------------------------------------------- 
function fig = graph_SEIRpAHDstate(time,t0,t1,S,E,I,R,A,H,D,N,...
                                   DataH,DataD,idx_H0,idx_D0,graphobj)
    ...
    figDataH  = semilogy([t0 t1],[DataH DataH],'-.',...
                         'LineWidth',0.7,...
                         'Color',brown);
    hold on
    figDataD  = semilogy([t0 t1],[DataD DataD],'--',...
                          'LineWidth',0.7,...
                          'Color','k');
    figDataHt = semilogy([idx_H0 idx_H0],[1 1e7],'-.',...
                         'LineWidth',0.7,...
                         'Color',brown);
    figDataDt = semilogy([idx_D0 idx_D0],[1 1e7],'--',...
                         'LineWidth',0.7,...
                         'Color','k');
    figDataHp  = semilogy([idx_H0 idx_H0],[DataH DataH],'*',...
                         'LineWidth',2.0,...
                         'DisplayName',graphobj.labelDataH,...
                         'Color',brown);
    figDataDp  = semilogy([idx_D0 idx_D0],[DataD DataD],'o',...
                         'LineWidth',2.0,...
                         'DisplayName',graphobj.labelDataD,...
                         'Color','k');
    
    figS = semilogy(time,S,'DisplayName',graphobj.labelS,'Color','b');
    figE = semilogy(time,E,'DisplayName',graphobj.labelE,'Color',yellow);
    figI = semilogy(time,I,'DisplayName',graphobj.labelI,'Color','r');
    figR = semilogy(time,R,'DisplayName',graphobj.labelR,'Color','g');
    figA = semilogy(time,A,'DisplayName',graphobj.labelA,'Color',orange);
    figH = semilogy(time,H,'DisplayName',graphobj.labelH,'Color',brown);
    figD = semilogy(time,D,'DisplayName',graphobj.labelD,'Color','k');
    figN = semilogy(time,N,'DisplayName',graphobj.labelN,'Color','m');
    set(gcf,'color','white');
