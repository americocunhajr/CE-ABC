% -----------------------------------------------------------------
% GetState_SEIRpAHDbeta.m
% -----------------------------------------------------------------
%  This function computes a dynamic state that is compatible with
%  a given death reference for a SEIR(+AHD)beta epidemic model.
%
...
function [IC,IC_H,idx_H0,IC_D,idx_D0] = ...
             GetState_SEIRpAHDbeta(param,tspan,IC0,H_ref,D_ref)

% ODE solver Runge-Kutta45
[time,y] = ode45(@(t,y)rhs_SEIRpAHDbeta(t,y,param),tspan,IC0);
